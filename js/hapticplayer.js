...
function initHaptics() {
    // Initialize haptics support via plugin
    hl = document.getElementById('pluginobj');
    if (hl.initDevice == undefined) {
        // Alert user if there no haptic plugin
